...
import { initializePhoenix, isPhoenixInitialized } from '@/lib/phoenix';
import { traceOpenRouterRequest } from '@/lib/phoenix-openrouter';

// Initialize Phoenix tracing on module load
if (!isPhoenixInitialized()) {
  initializePhoenix();
}
...
async function makeOpenRouterRequest(body, timeoutMs = 45000) {
  // Wrap the actual HTTP request in a function for Phoenix tracing
  ...
  // Trace the request with Phoenix
  return await traceOpenRouterRequest(body, executeRequest);
}
